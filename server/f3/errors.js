...
export const ERROR_STATUS = {
  ...
  // Reconciliation (Functional 12, spec 5 / 10.1)
  RECON_RUN_NOT_FOUND: 404,
  RECON_ISSUE_NOT_FOUND: 404,
  RECON_ISSUE_NOT_ACTIVE: 409,
  RECON_INVALID_ACTION: 400,
  RECON_REASON_REQUIRED: 400,
  // End-of-day closing (Functional 14, spec 5 / 10.1)
  CLOSING_NOT_FOUND: 404,
  CLOSING_DRAFT_NOT_FOUND: 404,
  CLOSING_ATTENTION_NOT_FOUND: 404,
  CLOSING_DRAFT_LOCKED: 409,
  CLOSING_ALREADY_CONFIRMED: 409,
  CLOSING_SOURCE_CHANGED: 409,
  CLOSING_PREVIEW_STALE: 409,
  CLOSING_COUNT_REQUIRED: 400,
  CLOSING_CONSENT_REQUIRED: 400,
  CLOSING_REASON_REQUIRED: 422,
  CLOSING_REASON_NOTE_REQUIRED: 422,
  // Infra
  OFFLINE: 503,
  PROVIDER_ERROR: 502,
  INTERNAL: 500,
...
export const ERROR_MESSAGE = {
  ...
  RECON_RUN_NOT_FOUND: "Không tìm thấy lần đối soát.",
  RECON_ISSUE_NOT_FOUND: "Không tìm thấy sai lệch.",
  RECON_ISSUE_NOT_ACTIVE: "Sai lệch này đã được xử lý.",
  RECON_INVALID_ACTION: "Thao tác không hợp lệ cho sai lệch này.",
  RECON_REASON_REQUIRED: "Vui lòng chọn lý do trước khi bỏ qua.",
  CLOSING_NOT_FOUND: "Không tìm thấy bản chốt ngày.",
  CLOSING_DRAFT_NOT_FOUND: "Không tìm thấy bản chốt đang làm.",
  CLOSING_ATTENTION_NOT_FOUND: "Không tìm thấy mục cần xem.",
  CLOSING_DRAFT_LOCKED: "Bản chốt đã khóa, không thể sửa. Hãy chốt lại để tạo bản sửa đổi.",
  CLOSING_ALREADY_CONFIRMED: "Ngày này đã được chốt.",
  CLOSING_SOURCE_CHANGED: "Số liệu nguồn vừa thay đổi. Vui lòng chuẩn bị lại và kiểm tra trước khi chốt.",
  CLOSING_PREVIEW_STALE: "Bản xem trước đã cũ. Vui lòng xem lại rồi chốt.",
  CLOSING_COUNT_REQUIRED: "Vui lòng nhập số tiền mặt đã đếm.",
  CLOSING_CONSENT_REQUIRED: "Vui lòng xác nhận đã kiểm tra số liệu trước khi chốt.",
  CLOSING_REASON_REQUIRED: "Vui lòng chọn lý do cho khoản chênh lệch.",
  CLOSING_REASON_NOTE_REQUIRED: "Vui lòng ghi chú lý do khi chọn ‘Khác’.",
